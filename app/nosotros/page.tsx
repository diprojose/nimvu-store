    ...
    <div className="bg-white text-black">
      ...
      <header className="py-24 px-6 md:px-16 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        <div className="max-w-xl">
          ...
          <h1 className="text-7xl md:text-9xl font-fraunces font-semibold leading-[0.8]">
            LA ESENCIA<br />
      ...
      <section className="relative max-w-7xl mx-auto px-6 md:px-16 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          <div className="text-left md:text-right md:pr-16 order-2 md:order-1 pt-12 md:pt-0">
            ...
            <h2 className="text-4xl font-fraunces font-semibold mb-6">Más que Decoración</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          ...
          <div className="text-left md:pl-16 pt-12 md:pt-0">
            ...
            <h2 className="text-4xl font-fraunces font-semibold mb-6">La Belleza de la Textura</h2>
        ...
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-5xl md:text-6xl font-fraunces font-semibold mb-12 italic">Curaduría para el Hogar Moderno</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-gray-200 pt-16 pb-32">
          <div className="p-4">
            <span className="text-3xl font-fraunces font-semibold text-gray-300 block mb-4">01.</span>
          ...
          <div className="p-4">
            <span className="text-3xl font-fraunces font-semibold text-gray-300 block mb-4">02.</span>
          ...
          <div className="p-4">
            <span className="text-3xl font-fraunces font-semibold text-gray-300 block mb-4">03.</span>
      ...
      {/* <section className="py-24 bg-zinc-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <h2 className="text-5xl font-fraunces font-semibold mb-24">El Estudio Creativo</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group">
              ...
              <h3 className="font-fraunces font-semibold text-xl mb-1">José Parejo Tovar</h3>
            ...
            <div className="group">
              ...
              <h3 className="font-fraunces font-semibold text-xl mb-1">Oriana Hernández</h3>
              <p className="text-[10px] tracking-widest uppercase text-black">CEO & Fundador</p>
            </div>
            <div className="group">
              <div className="relative aspect-[3/4] bg-gray-200 mb-6 overflow-hidden">
              ...
              <h3 className="font-fraunces font-semibold text-xl mb-1">José Parejo Hernández</h3>
            ...
            <div className="group">
              ...
              <h3 className="font-fraunces font-semibold text-xl mb-1">Emma Parejo</h3>
      ...
      <section className="py-32 bg-white text-center">
        <h2 className="text-4xl md:text-5xl font-fraunces font-semibold mb-6">Redefine tu entorno</h2>
