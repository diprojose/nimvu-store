  ...
  if (submitted) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center">
        <h1 className="text-4xl font-source-serif font-semibold mb-6">Mensaje Enviado</h1>
    ...
    <div className="bg-white text-black font-sans min-h-screen">
      <div className="max-w-4xl mx-auto px-6 py-24">
        <header className="mb-16 text-center">
          <h1 className="text-5xl md:text-6xl font-source-serif font-semibold">Contactanos</h1>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 py-4">
            <div>
              <h3 className="font-source-serif font-semibold text-2xl mb-2">Oficina</h3>
            ...
            <div>
              <h3 className="font-source-serif font-semibold text-2xl mb-2">Email</h3>
              <p className="text-gray-600">nimvustore@gmail.com</p>
            </div>
            <div>
              <h3 className="font-source-serif font-semibold text-2xl mb-2">Redes Sociales</h3>
